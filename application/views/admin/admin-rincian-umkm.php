              ...
              <div class="">
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                  <tbody>
                    <tr>
                      <td>Gambar</td>
                      <td><img src="<?= base_url('assets/img/profile/') . $umkm['gambar_umkm'] ?>" style="width: 200px" alt="umkm"></td>
                    </tr>
                    <tr>
                      <td>Nama</td>
                    ...
                    <tr>
                      <td>Username</td>
                      <td><?= $umkm['username_umkm'] ?></td>
                    </tr>
                    <tr>
                      <td>Email</td>
                      <td><?= $umkm['email_umkm'] ?></td>
                    </tr>
                    <tr>
                      <td>Alamat</td>
